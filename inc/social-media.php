...
$social_media_class = new SocialMedia();

add_action( 'customize_register', [ $social_media_class, 'register' ], 10, 1 );
...
Class SocialMedia {
	...
	public static function show() {
		...
		foreach ( (array) $social_media_args as $platform => $fa_icon ) {
			...
			if ( $link ) {
				echo "<li class='icon'><a href='{$link}'><i class='fa {$fa_icon}' aria-hidden='true'></i></a></li>";
			}
		}
		echo "</ul>";
	}
